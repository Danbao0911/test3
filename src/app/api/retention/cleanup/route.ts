...
export async function POST(request: Request) {
  ...
  const options = body && typeof body === "object" ? body as { batchSize?: number; contactCursor?: string; exportCursor?: string; suppressionCursor?: string; contactDone?: boolean; exportDone?: boolean; suppressionDone?: boolean; dryRun?: boolean } : {};
