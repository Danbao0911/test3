...
export function contactUsable(contact: { status: string; expiresAt: Date; ownershipConfirmed: boolean; businessConfirmed: boolean; reviewedAt: Date | null; evidence: { policyVersion: number; source: ContactPolicy } }, now = new Date()) {
